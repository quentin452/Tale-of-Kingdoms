...
public class EntityDefendKnight
extends EntityNPC {
    ...
    public void upgrade() {
        EntityLiving entityliving = (EntityLiving)EntityList.createEntityByName((String)"DefendPaladin", (World)this.worldObj);
    ...
    public boolean interact(EntityPlayer entityplayer) {
        ...
        if (!this.follow) {
            this.follow = true;
            if (!this.worldObj.isRemote) {
                ChatMessage.add(entityplayer,"Knight: I will follow you.");
            }
            this.defend.setDead();
            this.createdMarker = false;
        } else {
            this.follow = false;
            if (!this.worldObj.isRemote) {
                ChatMessage.add(entityplayer,"Knight:I will guard this area.");
            }
        }
        return true;
    }
